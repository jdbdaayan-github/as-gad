<template>
  <div class="min-h-screen flex bg-slate-50 font-sans text-slate-900">
    ...
    <!-- Sidebar Navigation -->
    <aside class="w-64 bg-white border-r border-slate-200 hidden md:flex flex-col flex-shrink-0 z-20">
      
      <!-- Brand Area -->
      <div class="h-14 flex items-center px-6 border-b border-slate-200 shrink-0">
      ...
      <nav class="flex-1 overflow-y-auto py-4 space-y-6 custom-scrollbar">
        ...
        <div class="px-3">
          ...
          <div class="space-y-1">
            ...
            <!-- Theme - Set as Active for demonstration -->
            <router-link 
              to="/admin/theme" 
    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden">
      ...
      <header class="h-14 bg-white border-b border-slate-200 px-4 lg:px-6 flex justify-between items-center z-10 shrink-0">
        ...
        <div class="flex items-center gap-4">
          <button class="md:hidden text-slate-500 hover:text-slate-900 focus:outline-none rounded-sm transition-colors">
...
<style>
/* Optional: Minimalist custom scrollbar */
